...
const projects = [
  {
    ...
    title: "project 1",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo est quo sint optio odit soluta eveniet. Delectus impedit consequatur quisquam praesentium ad! Dolore perferendis atque non consequuntur provident! Quas, accusantium!",
    stack: [
      {
        name: "HTML 5",
      },
        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          ...
          <div className="w-full xl:w-[50%]">
            <Swiper
              ...
              onSlideChange={(swiper) => handleSlidesChange(swiper)}
            >
